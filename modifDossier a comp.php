				...
				$etape = $reqetape->fetch();
	        		...
	        		$newnumclient = htmlspecialchars($_POST['newnumclient']);
		      		$newemail = htmlspecialchars($_POST['newemail']);
		       		...
		       		$finetude = htmlspecialchars($_POST['finetude']);
		       		$finress = htmlspecialchars($_POST['finress']);
		       		/*$finpoteau = htmlspecialchars($_POST['finpoteau']);*/
		       		$fincabl = htmlspecialchars($_POST['fincabl']);
		       		$finraccord = htmlspecialchars($_POST['finraccord']);
		       		$finconfig = htmlspecialchars($_POST['finconfig']);
		       		$finrecu = htmlspecialchars($_POST['finrecu']);
		       		//progression
	        		...
	        		$modifplan ->execute(array($newetat, $newintervention, $newcloture, $_GET['idDossier']));
			   		...
			   		//modif descriptif
		       		$modifdes = $bdd ->prepare('UPDATE dossier SET descriptif= ? WHERE idDossier = ?');
	        		$modifdes ->execute(array($newdescriptif, $_GET['idDossier']));
	        		...
	        		//modif etape
	        			...
	        			if (isset($etude)) {
	        				...
	        				if (isset($etudeinfo) && $etudeinfo != $etude) {
									...
									<tr class="row100">
										...
										<td class="column100 column3" data-column="column3">
											...
											<?php  
													...
													$etapeinfo = $reqstep->fetch(); 
													echo $etapeinfo['finEtape'];
													echo'<input type="date" name="finpoteau">';
										...
										<td class="column100 column3" data-column="column3">
											...
											<td class="column100 column4" data-column="column4">
												<?php  
													...
													echo $etapeinfo['finEtape'];
												?>
												<input type="date" name="finraccord">
										...
										<td class="column100 column3" data-column="column3">
											...
											<td class="column100 column4" data-column="column4">
												<?php  
													...
													echo $etapeinfo['finEtape'];
												?>
												<input type="date" name="finconfig">
