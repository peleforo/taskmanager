	 ...
	 try {
        ...
        if (isset($_GET['idDossier'])) {
        	...
        	if (isset($_POST['fichier'])) {
					    ...
					    $extensions = ['jpg', 'png', 'jpeg', 'gif', 'pdf', 'xlsx', 'doc'];
					    $maxSize = 400000;
						    ...
						    if(in_array($extension, $extensions) && $size <= $maxSize && $error == 0){
						      ...
						      /*  $uniqueName = uniqid('', true);
						        ...
						        $insertfichier =$bdd->prepare("INSERT INTO fichier (nomFichier,url,dossier) VALUES (?,?,?)");
		       					$insertfichier ->execute(array($_POST['doc'],$desti,$getid));
