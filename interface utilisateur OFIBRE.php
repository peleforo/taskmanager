	...
	<div class="row">
		...
		<!-- visualisation des dossiers selon leur etat-->
			<div class="col-xs-12 col-sm-11 col-md-11 col-lg-11"  >
				<h1 style="text-align: center; font-size: 50px;margin-bottom: 50px;">OFIBRE <span title="Ajoutez un nouveau dossier"><a href="nouveaudossier CI.php"><img src="bouton ajout.png"></a></span></h1>
